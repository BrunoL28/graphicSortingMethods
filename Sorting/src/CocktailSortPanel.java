...
/*
Também conhecido como Shaker Sort, é uma variação do Bubble Sort.
Percorre a lista em ambas as direções, movendo o maior elemento para o 
final e o menor para o início, alternadamente.
*/
