...
public class Main extends JPanel {
    ...
    public Main() {
        ...
        sortPanels[1] = new CocktailSortPanel("Cocktail Sort", sleepTime, width, height);
        sortPanels[2] = new CombSortPanel("Comb Sort", sleepTime, width, height);
        ...
        sortPanels[5] = new MergeSortPanel("Merge Sort", sleepTime, width, height);
        sortPanels[6] = new QuickSortPanel("Quick Sort", sleepTime, width, height);
        sortPanels[7] = new SelectionSortPanel("Selection Sort", sleepTime, width, height);
        sortPanels[8] = new ShellSortPanel("Shell Sort", sleepTime, width, height);
    ...
    public static void main(String args[]) {
        ...
        JFrame frame = new JFrame("Sorting Algorithms Animations");
        Main main = new Main();
        frame.add(main);
