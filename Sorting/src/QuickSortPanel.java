...
/*
Escolhe um elemento pivô, rearranja os elementos de forma que os menores fiquem à 
esquerda e os maiores à direita do pivô.
...
public class QuickSortPanel extends SortPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (cyanColumn != -1) {
            ...
            g.fillRect(2 * BORDER_WIDTH + cyanColumn * columnWidth, getHeight() - list[cyanColumn] * columnHeight - 2 * BORDER_WIDTH, columnWidth, list[cyanColumn] * columnHeight);
            g.setColor(Color.BLACK);
            g.drawRect(2 * BORDER_WIDTH + cyanColumn * columnWidth, getHeight() - list[cyanColumn] * columnHeight - 2 * BORDER_WIDTH, columnWidth, list[cyanColumn] * columnHeight);
        }
    }
}
