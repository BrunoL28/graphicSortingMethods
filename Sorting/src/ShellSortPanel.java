...
/*
É uma variação de inserção que compara elementos distantes entre si e 
troca elementos que estão fora de ordem.
Usa uma sequência de lacunas ou incrementos que reduzem 
à medida que o algoritmo avança, até que o último passo 
seja uma simples ordenação por inserção.
*/
